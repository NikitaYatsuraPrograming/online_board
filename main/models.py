...
from django.dispatch import Signal  # Импорт сигналов
...
# Сигнал о создании нового пользователя
...
# Отправка письма при успешном добавлении комментария
